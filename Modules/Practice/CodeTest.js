...
console.log('\nQ3');
const arr3 = ['BASEBall', 'FOOTBALL', 'rUGBy', 'bASEball', 'sOCcEr', 'BaskETBall', 'bAsEbAlL', 'mARAthon'];
let arr3Result = arr3.map(word => word.toLocaleLowerCase());          // final ans should be in this variable
...
console.log(arr3);
console.log(`the index of second-occurrence of 'baSeBalL' (ignoring cases) in the arr3-array : ${index}`);